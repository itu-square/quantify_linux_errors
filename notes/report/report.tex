...
\textbf{Observation 2:}
Two out of three \emph{code pollution} warnings \emph{unused-function} and 
...
\emph{unused-function} and \emph{unused-variable}
\\
...
\textbf{Conclusion 1:}
The most common warnings, are warnings regarding \emph{code pollution}, and
next come warnings related to variables being uninitialized.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            \section{Only One Software Product}


            %%% ONLY ONE ARCHITECTURE
            \section{Only One Architecture}
