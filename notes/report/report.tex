...
These warnings will not break the code, or return wrong values, merely be 
...
This is an error, and will be categorized as \emph{irrelevant}.
...
This warning shows when there is an uncertainty about a variable being uninitialized. In the 
...
\textbf{Observation 1:}
The most common warnings in the \emph{Wrong data} category are: 
\emph{x}, \emph{x}, and 
\emph{x}.
\\

\textbf{Observation 2:}
The most common warnings in the \emph{Code pollution} category are: 
\emph{x}, \emph{x}, and 
\emph{x}.
\\

\textbf{Observation 3:}
The most common warnings in the \emph{Bad code practice} category are: 
\emph{x}, \emph{x}, and 
\emph{x}.
\\
...
The green and blue rows are subsystems that are not a major part of the kernel 
functionality, as mentioned in  Section \ref{sec:linuxss}.
\\
...
\figa
    \begin{tabular}{r|d|d|c}
        \hline
        \hline
        \textbf{Warning} & \multicolumn{1}{|c|}{\textbf{Stable}} & 
        \textbf{In-Dev} & \textbf{Category}\\
        \hline
        ...
        int-conversion & 2.7 \% & 4.2 \% & Wrong data \\
            \rowcolor{green!20}
        implicit-function-declaration & 5.6 \% & 23. \% & Bad code practice \\ % 4.6 added from 2 lines up.
            \rowcolor{red!20}
