...
bundle.
        ...
        \section{The Linux Kernel}
            ...
            \def \fn {See the \textbf{README} file in the Linux kernel tree}
...
very scalable\f, it is the operating system that supports the most hardware in
...
When a configuration file is created, it is saved as \texttt{.config}.
...
the feature clauses in the files. 
\\
...
experiment runs with the stable Linux kernel. The distinct warning types are 
