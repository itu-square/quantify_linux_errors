...
regarding lines of code (LOC) and size. A quick description of some of the 
subsystems will follow.  For a visualization of the sizes of the subsystems see 
figure ~\ref{fig:subsystems}.
...
the \textcode{arch} folder, and the sizes can be seen in figure 
~\ref{fig:archsizes}.
...
\section{Kconfig - The Feature Model Language}
