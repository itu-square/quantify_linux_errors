...
\title{A Quantitative Analysis of Variability Bugs in Linux \\ Draft: \today}
...
diagram. See figure \ref{kconfigphone} for the corresponding Kconfig file. It 
...
The phone example is greatly inspired by examples from the SPLOT repository of 
example and real feature models
    \cite{SPLOT}
.
\\
