...
scattered all over the Linux kernel tree, where they include each other.
\\
...
\figb{A real Kconfig example showing a choice clause with 5 choices}{kconfigtypes}
...
\figa
    --- Feature diagram of tiny example ---
\figb{}{}
